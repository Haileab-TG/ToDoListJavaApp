...
public class WorkCont implements Initializable, Loadable {
    ...
    @FXML
    void openAddTaskPop(ActionEvent event) {
        try {
            ...
            addTaskController.setCallerInfo(Callers.WORK, primaryStage, this);
            primaryStage.show();
        } catch (IOException e) {
        ...
        listView.getSelectionModel().selectedItemProperty().addListener(event -> {
            if(!(listView.getSelectionModel().getSelectedItems().isEmpty())){
                try {
                    ...
                    updateTaskController.setCallerInfo(Callers.WORK, updateTaskStage, this);
